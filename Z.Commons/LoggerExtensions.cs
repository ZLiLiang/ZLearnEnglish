...
namespace Z.Commons
{
    ...
    {
        public static void LogInterpolatedCritical(this ILogger logger, FormattableString formattableString, Exception? exception = default, EventId eventId = default)
        {
        ...
        public static void LogInterpolatedDebug(this ILogger logger, FormattableString formattableString, Exception? exception = default, EventId eventId = default)
        {
