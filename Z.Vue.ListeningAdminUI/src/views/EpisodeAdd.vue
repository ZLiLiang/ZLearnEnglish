<template>
    <el-form ref="form" label-width="80px">
        ...
        <el-form-item label="音频路径">
            <audio id="player" @durationchange="playerDurationChange" style="display:none" :src="state.audioUrl"
                controls></audio>
...
import ZackUploader from '../components/ZUploader.vue';
...
export default {
    ...
    setup() {
        ...
        const state = reactive({
            name: { chinese: "", english: "" }, albumId: albumId, audioUrl: "",
