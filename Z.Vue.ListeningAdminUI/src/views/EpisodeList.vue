<template>
    <div>
        <el-button-group>
            ...
            <el-button type="primary" icon="el-icon-circle-plus-outline" @click="startSort"
                v-show="!state.isInSortMode">排序</el-button>
...
export default {
    ...
    setup() {
        ...
        return {
            state, deleteItem, showItem, hideItem, tableRowClassName, addnew, edit,
            floatItem, sinkItem, startSort, saveSort, renderEncodingStatus, reloadData
        };
    },
}
</script>
<style lang="css">.inVisibleEpisode {
