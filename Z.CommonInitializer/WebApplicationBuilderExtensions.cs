...
namespace Z.CommonInitializer
{
    public static class WebApplicationBuilderExtensions
    {
        ...
        /// <summary>
        /// 注册所有DbContexts、JWT权限认证、Swagger、MediatR、Filter过滤器、时间格式、跨域Cors、日志Logging、FluentValidation验证器、RabbitMQ_EventBus、分布式redis
        /// </summary>
        ...
        public static void ConfigureExtraServices(this WebApplicationBuilder builder, InitializerOptions initOptions)
        {
            ...
            services.AddCors(options =>
            {
                ...
                options.AddDefaultPolicy(policy => policy.WithOrigins(urls)
                .AllowAnyMethod()
                .AllowAnyHeader()
                .AllowCredentials());
            });
