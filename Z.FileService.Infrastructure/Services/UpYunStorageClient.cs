...
namespace Z.FileService.Infrastructure.Services
{
    ...
    /// 又拍云存储服务
    /// </summary>
    public class UpYunStorageClient : IStorageClient
    {
        private IOptionsSnapshot<UpYunStorageOptions> options;
        private IHttpClientFactory httpClientFactory;

        public UpYunStorageClient(IOptionsSnapshot<UpYunStorageOptions> options, IHttpClientFactory httpClientFactory)
        {
